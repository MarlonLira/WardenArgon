        ...
        <%
            ...
            if (Table != null) {
                foreach (DataRow Row in Table.Rows) {
                    ...
                    card_control.Matricula = Row["codigo"].ToString();
                    card_control.Date = "23/06/2019";
                    card_control.Href = "?Matricula=" + Row["codigo"].ToString() + "&Empresa=" + Row["empresa_id"].ToString();

                %>
              <usc:CardUsc ID="card_control" runat="server" Text=" teste2" UrlImg="/assets/img/default-avatar.png"/>
        <%} } %>
